...
public class AudioCollector extends Thread {
	...
	public void run() {
		...
		mAudioRecord = new AudioRecord(MediaRecorder.AudioSource.MIC, mSampleRate, AudioFormat.CHANNEL_IN_MONO, AudioFormat.ENCODING_PCM_16BIT, mMinBufferSize); // mMinBufferSize这个参数必须大于等于一帧
